...
class strategy(ABC):
    ...
    def __init__(self, name):
        ...
        self._uls_universe = None
        self._weights_df = None

        # Calculated Dataframes
        self._pv_df = None
        self._spis_df = None
        self._reb_weights_df = None 
        self._reb_underlyings_df = None
        self._reb_pv_df = None
        self._reb_spis_df = None
        
        #Performance attributes
        self._annualized_return = None
        self._total_return = None
        self._annualized_vol = None
    ...
    def performance_table(self, benchmarks):
        self._performance_table = benchmarks
    ...
    def annualized_return(self, benchmarks):
        self._annualized_return = benchmarks
    ...
    def annualized_vol(self, benchmarks):
        self._annualized_vol = benchmarks
    ...
    def pv_df(self, benchmarks):
        self._pv_df = benchmarks

    @property
    def spis_df(self):
        return self._spis_df 
    
    @spis_df.setter
    def spis_df(self, benchmarks):
        self._spis_df = benchmarks

    @property
    def reb_spis_df(self):
        return self._reb_spis_df 
    
    @reb_spis_df.setter
    def reb_spis_df(self, benchmarks):
        self._reb_spis_df = benchmarks

    @property
    def reb_pv_df(self):
        return self._reb_pv_df
    
    @reb_pv_df.setter
    def reb_pv_df(self, benchmarks):
        self._reb_pv_df = benchmarks

    @property
    def ULs_universe(self):
        return self._uls_universe
    
    @ULs_universe.setter
    def ULs_universe(self, Uls):
        self._uls_universe = Uls
...
class momentum(strategy):
    ...
    def extract_timeseries_for_rebalancing(self, reb_freq):
        ...
        reb_weights = self._weights_df.loc[rebalancing_dates]
    ...
    def calc_spis_pv(self):
        ...
        if self._reb_weights_df is None :
        ...
        data = []
        reb_weights = self._reb_weights_df
